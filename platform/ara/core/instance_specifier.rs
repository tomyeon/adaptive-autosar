...
pub enum InstanceSpecifierError {
    ...
    #[error("Invalid meta model shortname (0)")]
    ...
    #[error("Invalid meta model path (0)")]
...
impl<'a> InstanceSpecifier<'a> {
    ...
    fn to_string(&self) -> &'a str {
        // C++ doesn't support this requirement since how it catches when self.meta_model_identifier is dropped?
